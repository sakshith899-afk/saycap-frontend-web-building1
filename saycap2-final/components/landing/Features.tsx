...
const FEATURES = [
  { emoji: "🎙️", title: "11 languages, zero headaches", body: "Telugu, Hindi, Tamil, Kannada, Malayalam, Bengali, Gujarati, Marathi, Punjabi, Odia, Indian English. Switch in one click.", span: "col-span-1" },
  { emoji: "⏱️", title: "Frame-perfect every time", body: "Every word syncs to the exact millisecond. Drop SRT or VTT into Premiere, CapCut, or DaVinci. It just works.", span: "col-span-1" },
  { emoji: "🔀", title: "Tenglish. Hinglish. Kanglish.", body: "Your audio switches languages mid-sentence. So does SAYCAP. Code-mixed speech handled natively, not as an afterthought.", span: "col-span-1" },
  { emoji: "🔒", title: "Your audio never stays", body: "Processed and deleted immediately. We don't train on your content. What you upload is yours.", span: "col-span-1" },
];
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        <Reveal>
          <div style={{ marginBottom: 72 }}>
            ...
            <h2 className="t-h2" style={{ maxWidth: 600, marginTop: 16 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(12, 1fr)", gap: 12 }}>
          ...
          {/* Output modes — wide card */}
          <Reveal delay={100} style={{ gridColumn: "span 7" }}>
            <div className="card-skeu" style={{ padding: "32px 28px", height: "100%" }}>
